...
int    BLASFUNC(saxpy) (const int *, const float  *, const float  *, const int *, float  *, int *);
int    BLASFUNC(daxpy) (const int *, const double *, const double *, const int *, double *, int *);
int    BLASFUNC(qaxpy) (const int *, const double *, const double *, const int *, double *, int *);
int    BLASFUNC(caxpy) (const int *, const float  *, const float  *, const int *, float  *, int *);
int    BLASFUNC(zaxpy) (const int *, const double *, const double *, const int *, double *, int *);
int    BLASFUNC(xaxpy) (const int *, const double *, const double *, const int *, double *, int *);
int    BLASFUNC(caxpyc)(const int *, const float  *, const float  *, const int *, float  *, int *);
int    BLASFUNC(zaxpyc)(const int *, const double *, const double *, const int *, double *, int *);
int    BLASFUNC(xaxpyc)(const int *, const double *, const double *, const int *, double *, int *);
